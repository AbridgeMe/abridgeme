...
@interface ViewController : UIViewController<UISearchBarDelegate,UIAlertViewDelegate,MBProgressHUDDelegate,UIScrollViewDelegate>{
...
@property (strong, nonatomic) NSMutableArray *NewSummaryDataDictArray;
@property (strong, nonatomic) IBOutlet UISearchBar *searchBar;

@property(nonatomic,strong)NSMutableArray *allDataArray;
@property(nonatomic,strong)NSArray *allTopic;
